...
"""
word-cloud documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'word-cloud',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/word-cloud",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Word Cloud XBlock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'word_cloud_2'),
                os.path.join(root_path, 'word_cloud_2/migrations')])
